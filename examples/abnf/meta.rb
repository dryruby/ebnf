...
module ABNFMeta
  RULES = [
    ...
    EBNF::Rule.new(:_quoted_string_2, nil, [:alt, :_quoted_string_3, :_quoted_string_4]).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_quoted_string_3, nil, [:range, "#x20-#x21"], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_quoted_string_4, nil, [:range, "#x23-#x7E"], kind: :terminal).extend(EBNF::PEG::Rule),
    ...
    EBNF::Rule.new(:_prose_val_2, nil, [:alt, :_prose_val_3, :_prose_val_4]).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_prose_val_3, nil, [:range, "#x20-#x3D"], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_prose_val_4, nil, [:range, "#x3F-#x7E"], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:ALPHA, nil, [:alt, :_ALPHA_1, :_ALPHA_2], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_ALPHA_1, nil, [:range, "#x41-#x5A"], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_ALPHA_2, nil, [:range, "#x61-#x7A"], kind: :terminal).extend(EBNF::PEG::Rule),
