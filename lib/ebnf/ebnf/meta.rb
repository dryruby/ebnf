...
module EBNFMeta
  RULES = [
    ...
    EBNF::Rule.new(:RANGE, "14", [:seq, "[", :_RANGE_1, "]"], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_1, "14.1", [:alt, :_RANGE_2, :_RANGE_3], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_2, "14.2", [:seq, "-", :_RANGE_4], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_4, "14.4", [:plus, :_RANGE_5], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_5, "14.5", [:alt, :_RANGE_6, :_RANGE_7, :R_CHAR, :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_6, "14.6", [:seq, :R_CHAR, "-", :R_CHAR], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_7, "14.7", [:seq, :HEX, "-", :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_3, "14.3", [:seq, :_RANGE_8, :_RANGE_9], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_8, "14.8", [:plus, :_RANGE_10], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_10, "14.10", [:alt, :_RANGE_11, :_RANGE_12, :R_CHAR, :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_11, "14.11", [:seq, :R_CHAR, "-", :R_CHAR], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_12, "14.12", [:seq, :HEX, "-", :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_RANGE_9, "14.9", [:opt, "-"], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:O_RANGE, "15", [:seq, "[^", :_O_RANGE_1, "]"], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_1, "15.1", [:alt, :_O_RANGE_2, :_O_RANGE_3], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_2, "15.2", [:seq, "-", :_O_RANGE_4], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_4, "15.4", [:plus, :_O_RANGE_5], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_5, "15.5", [:alt, :_O_RANGE_6, :_O_RANGE_7, :R_CHAR, :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_6, "15.6", [:seq, :R_CHAR, "-", :R_CHAR], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_7, "15.7", [:seq, :HEX, "-", :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_3, "15.3", [:seq, :_O_RANGE_8, :_O_RANGE_9], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_8, "15.8", [:plus, :_O_RANGE_10], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_10, "15.10", [:alt, :_O_RANGE_11, :_O_RANGE_12, :R_CHAR, :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_11, "15.11", [:seq, :R_CHAR, "-", :R_CHAR], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_12, "15.12", [:seq, :HEX, "-", :HEX], kind: :terminal).extend(EBNF::PEG::Rule),
    EBNF::Rule.new(:_O_RANGE_9, "15.9", [:opt, "-"], kind: :terminal).extend(EBNF::PEG::Rule),
